...
import com.amazonaws.services.s3.model.{GetObjectRequest, ListObjectsRequest, ObjectMetadata, PutObjectRequest}
...
object LeoFS{
  ...
  val bucket = s3.createBucket(leofsConfig.getString("bucket"));
